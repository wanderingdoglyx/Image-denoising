function [lv_mask, DI_resliced_base, flag_seg] = ze_get_lv_seg_resized(...
  ...
  S = ze_get_dir(fdir, series_desc_sa_recon, pat_id);
...
%   figure; imshow3D(lv_mask);
  ...
  %lv_mask = imresize3(lv_mask, 0.5, 'Method', 'linear'); %resize %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
