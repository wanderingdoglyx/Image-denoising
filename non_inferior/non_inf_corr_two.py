...
cameria='CZT'
extends=['extind0','extind1','extind2']
...
#file1_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder1}/t_ZT_male_loc_a_i_sev_100_175_250_ext_30_60_subsample30_IO0_Ud32.txt')
    file1_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_{extend}.txt')
    #file1_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_lmbdchdiff6_lmbdmdiff0_M.txt')

    file2_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_lmbdchdiff7_lmbdmdiff0_{extend}.txt')
    #file2_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32.txt')
    ...
    output=f'DEMIST_d4_d4_L7_{extend}.csv'
#output=f'DEMIST_d1_d4.csv'
...
for extend in extends:
#file1_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder1}/t_ZT_male_loc_a_i_sev_100_175_250_ext_30_60_subsample30_IO0_Ud32.txt')
    file1_data = read_groups_from_file(f'tSN_seall_d1_c30o5_IO0_Ud32_{extend}.txt')
    #file1_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_lmbdchdiff6_lmbdmdiff0_M.txt')

    #file2_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_lmbdchdiff7_lmbdmdiff0_{extend}.txt')
    file2_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_{extend}.txt')

    #file2_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder2}/t_{cameria}_loc_a_i_sev_100_175_250_ext_30_60_subsample{folder2}_IO0_Ud32.txt')

    #output=f'{folder1}_{folder2}.csv'
    output=f'DEMIST_d1_d4_{extend}.csv'
#output=f'DEMIST_d1_d4.csv'
