...
for cameria in camerias:
    for lmbdchdiff in lmbdchdiffs:
    #cameria='CZT'
    #file1_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder1}/t_ZT_male_loc_a_i_sev_100_175_250_ext_30_60_subsample30_IO0_Ud32.txt')
        file1_data = read_groups_from_file(f't_DE_{cameria}_loc_a_i_sev_100_175_250_ext_30_45_60_dose_level{dose_level1}_IO0_Ud32.txt')

        #file2_data = read_groups_from_file(f'/data01/user-storage/y.zezhang/2024_subsample_project/mod_SA_images/{folder2}/t_ZT_fe_loc_a_i_sev_100_175_250_ext_30_60_subsampled{dose_level2}_lmbdchdiff7_nn_IO0_Ud32.txt')

        file2_data = read_groups_from_file(f't_DE_{cameria}_loc_a_i_sev_100_175_250_ext_30_45_60_dose_level{dose_level2}_IO0_Ud32_nn.txt')

    
        output=f'd{dose_level1}_d{dose_level2}_lmbdchdiff{lmbdchdiff}_{cameria}_ge.csv'
...
for cameria in camerias:
    ...
    file2_data = read_groups_from_file(f't_DE_{cameria}_loc_a_i_sev_100_175_250_ext_30_45_60_dose_level1_IO0_Ud32.txt')


    output=f'd{dose_level1}_d1_{cameria}_ge.csv'
