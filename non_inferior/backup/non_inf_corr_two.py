...
file1_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_M.txt')

file2_data = read_groups_from_file(f'tSN_seall_d4_c30o5_IO0_Ud32_lmbdchdiff6_lmbdmdiff0_M.txt')
#file2_data = read_groups_from_file(f'tSN_seall_d1_c30o5_IO0_Ud32_F.txt')
...
output=f'M_highdose_d4_d1_L6.csv'
# Write to a CSV file
