    ...
    for k = 1 : length(subFolders)
        ...
        for mode_idx = 1:length(mode)
            ...
            if mode_index==0 
                ...
                patient_folder=fullfile(mod_proj_base_folder_hl,subFolders(length(subFolders)-k+1).name);
            ...
            elseif mode_index==1 
                ...
                patient_folder=fullfile(mod_proj_base_folder_def,subFolders(length(subFolders)-k+1).name);
                ict_patient_folder=fullfile(mod_proj_base_folder_hl,subFolders(length(subFolders)-k+1).name);
