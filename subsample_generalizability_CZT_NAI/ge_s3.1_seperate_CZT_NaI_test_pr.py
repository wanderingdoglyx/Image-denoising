...
excel_file_2 = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/collimator_testing_data_hl.xlsx'  # Replace with the actual path
...
# Output files
czt_output_file = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/patients_with_CZT_ZT_test_hl.txt'
nai_output_file = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/patients_with_NaI_ZT_test_hl.txt'
...
excel_file_1 = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/collimator_testing_data_def.xlsx'  # Replace with the actual path
#main_directory = '/data01/user-storage/y.zezhang/2024_subsample_project/mod_subsample_projection/30/hl_asq_full'             # Replace with the path to the directory containing subfolders

# Output files
czt_output_file = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/patients_with_CZT_ZT_test_def.txt'
nai_output_file = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/patients_with_NaI_ZT_test_def.txt'
