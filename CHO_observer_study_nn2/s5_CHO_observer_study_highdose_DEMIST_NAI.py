...
for dose_level in dose_levels:
    ...
    fname_tSN = f'{save_folder}/t_DE_NAI_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_dose_level{dose_level}_IO{isIO}_Ud{Ud}.txt'
