...
for dose_level in dose_levels:
    ...
    for lmbdchdiff_index in lmbdchdiffs:
        ...
        fname_tSN = f'{save_folder}/t_DE_CZT_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_dose_level{dose_level}_IO{isIO}_Ud{Ud}_nn.txt'
