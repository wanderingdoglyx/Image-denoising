...
severity_setting=  [250,500] #[100,175,250]
...
for dose_level in dose_levels:
  ...
  fname_tSN = f'{save_folder}/trainingdata_DEMIST_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_{dose_level}_IO{isIO}_Ud{Ud}.txt'
