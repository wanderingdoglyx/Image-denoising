...
pat_id_arr_fname = f'/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/patients_with_CZT_DE_test_def.txt'
diseased_patients = np.loadtxt(pat_id_arr_fname, dtype = 'str', comments="#", delimiter=",", unpack=False)

pat_id_arr_fname = f'/datastore01/user-storage/y.zezhang/2025_high_dose_project/document/collimator_record/patients_with_CZT_DE_test_hl.txt'
...
#observer_study_list = ['nn_pred_DEMIST','testing/test_total_DEMIST']

dose_levels=[1, 4]

def_folder='/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/neural_network_data/def_centroid'
base_folder = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/neural_network_data/testing/test_total_DEMIST'
...
for dose_level in dose_levels:
    ...
    fname_tSN = f'{save_folder}/t_DE_CZT_loc_{location_setting_combined}_sev_{severity_setting_combined}_ext_{extent_setting_combined}_dose_level{dose_level}_IO{isIO}_Ud{Ud}.txt'
