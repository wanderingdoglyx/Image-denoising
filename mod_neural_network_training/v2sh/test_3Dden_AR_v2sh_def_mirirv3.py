...
#=============================================================================================================================
def test_seg3D(base_folder, weights_name, loss_fn_name, dose_level, num_iter, bt_size, num_epochs, learning_folder,
  ...
  #----------------------------------------------------------
  section_folder_base='/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/neural_network_data'
  ...
  data_folder = f'{section_folder_base}/testing/test_data_mirirv3_sa_wd_48cube'
  ...
  pat_id_arr = os.listdir('/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/neural_network_data/testing/test_data_mirirv3_sa_wd_48cube')
  pat_id_arr_hl =pat_id_arr
  pat_id_arr_def=pat_id_arr
  ...
  if def_name =='hl':
    for hd in ['hl']:
      for ind_pat in range(num_test_dict_hl[hd]['start_ind'], num_test_dict_hl[hd]['end_ind'] + 1):
        ...
        cur_inp_file = f'{data_folder}/{pat_id_arr_hl[ind_pat]}/{def_name}/recon_pat{pat_id_arr_def[ind_pat]}_d4_it{num_iter}_c30o5.img'
    ...
    for hd in ['def']:
      for ind_pat in range(num_test_dict_def[hd]['start_ind'], num_test_dict_def[hd]['end_ind'] + 1):
        ...
        #cur_inp_file = f'{data_folder}/{pat_id_arr_def[ind_pat]}/{def_name}/recon_pat{pat_id_arr_def[ind_pat]}_d{dose_level}_it{num_iter}_c30o5.img'
        cur_inp_file = f'{data_folder}/{pat_id_arr_def[ind_pat]}/{def_name}/recon_pat{pat_id_arr_def[ind_pat]}_d4_it{num_iter}_c30o5.img'
  ...
  com_flag_new = f'_{def_name}_d{dose_level}_it{num_iter}_b{bt_size}_lmbdchdiff{lambda_val_ind_chdiff}_lmbdmdiff{lambda_val_ind_mdiff}'
...
if __name__ == '__main__':
  ...
  test_seg3D(args.base_folder, args.weights_name, args.loss_fn_name, args.dose_level, args.num_iter, args.batch_size, args.epochs, args.learning_folder,
