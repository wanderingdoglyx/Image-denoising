...
def test_seg3D(base_folder, weights_name, loss_fn_name, dose_level, num_iter, bt_size, num_epochs, learning_folder,
  ...
  data_folder = f'{section_folder_base}/testing/test_data_sa_wd_fix2_48cube'
  #data_folder=f'{base_folder}/training_data_sa_wd_fix2_48cube'
  mod_data_folder = f'{base_folder}/learning/{learning_folder}'  ##########################################################
  #label_data_folder=f'{section_folder_base}/30/testing'
  ...
  pat_id_arr_fname = f'{section_folder_base}/test_pat_list_hl.txt'
  #pat_id_arr = os.listdir('/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/neural_network_data/testing/test_data_sa_wd_fix2_48cube')
  ...
  for hd in ['hl']:
    for ind_pat in range(num_test_dict[hd]['start_ind'], num_test_dict[hd]['end_ind'] + 1):
      ...
      cur_inp_file = f'{data_folder}/{pat_id_arr[ind_pat]}/{def_name}/recon_pat{pat_id_arr[ind_pat]}_d4_it{num_iter}_c30o5.img'
