...
def test_seg3D(base_folder, weights_name, loss_fn_name,dose_level, num_iter, bt_size, num_epochs, learning_folder,
  ...
  # load protocols,dose_level_max = 30
  num_z_slice = 64
  num_reg = 1
  ...
  pat_id_arr_fname = f'{section_folder_base}/test_pat_list.txt' ###################################################################
  #pat_id_arr = os.listdir('/data01/user-storage/y.zezhang/2024_subsample_project/mod_Neural_network_training/'+st,dose_level)+'/testing')
