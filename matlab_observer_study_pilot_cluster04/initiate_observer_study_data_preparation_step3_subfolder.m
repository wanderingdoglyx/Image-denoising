...
sourceDir_def = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/observer_study/pilot_study/all_submission/def';
sourceDir_hl = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/observer_study/pilot_study/all_submission/hl';
% Specify the target directories for PNG and GIF files
targetDirPng = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/observer_study/pilot_study/all_submission/png';
targetDirGif = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/observer_study/pilot_study/all_submission/gif';
