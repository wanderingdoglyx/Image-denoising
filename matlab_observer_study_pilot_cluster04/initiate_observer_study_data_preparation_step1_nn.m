...
sa_folder_base='/datastore01/user-storage/y.zezhang/2025_high_dose_project/data/neural_network_data/nn_pred_DEMIST';
...
for lmbdchdiff_index=1:1:length(lmbdchdiff_settings)
    ...
    for i=1:1:length(hl_image_select)
        for dose_index=1:1:length(dose_level)
            ...
            %nn_folder_name=append('subsample_3d_v',nn_version,'_d',dose_level_cur,'_lmbdchdiff',lmbdchdiff,'_nn');
           ...
           % pat_folder=fullfile(sa_folder_base,'healthy',pat_No);
            pat_filefolder=fullfile(sa_folder_base,'hl');


            nn_save_folder=append(dose_level_cur,'_lmbdchdiff',lmbdchdiff,'_nn');
            ...
            try
                ...
                gif_filename=append('pat',pat_No,'_d',dose_level_cur,'_lmbdchdiff',lmbdchdiff,'_nn','.gif');
            ...
            lowdose=append('recon_pat',pat_No,'_hl','_d', dose_level_cur,'_it8_b32_lmbdchdiff',lmbdchdiff,'_lmbdmdiff0.img');
            ...
            png_save_name=append('pat',pat_No,'_d',dose_level_cur,'_lmbdchdiff',lmbdchdiff,'_nn');
    ...
    for i=1:1:length(def_image_select)
        for dose_index=1:1:length(dose_level)
            ...
            pat_filefolder=fullfile(sa_folder_base,def_type_cur);
            ...
            try
                ...
                gif_filename=append('pat',pat_No,'_d',dose_level_cur,'_',def_type_cur,'_lmbdchdiff',lmbdchdiff,'_nn','.gif');
            ...
            lowdose=append('recon_pat',pat_No,'_',def_type_cur,'_d', dose_level_cur,'_it8_b32_lmbdchdiff',lmbdchdiff,'_lmbdmdiff0.img');
            lowdose_file_dir=fullfile(pat_filefolder,lowdose);
            ...
            png_save_name=append('pat',pat_No,'_d',dose_level_cur,'_',def_type_cur,'_lmbdchdiff',lmbdchdiff,'_nn');
