...
def initial_simind_pipline(patient_list,mode_index,extension,severity,location,gender_index,simind_collimator_index):
                ...
                for location_index in location:
                    for gender_index in gender:
                        for simind_collimator_index in simind_collimator:
                            ...
                            initial_simind_pipline(patient_list,mode_index,extension,severity,location_index,gender_index,simind_collimator_index)
