...
study_name='male_pilot_study'
modalities=3
number_of_reader=3
number_of_nondiseased_case=30
number_of_diseased_case=30

name_of_modalities=['high count','normal count','DEMIST']
...
#folder_path = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/observer_study_04_main/stratified study/sexes/csv_results/female'
folder_path = '/datastore01/user-storage/y.zezhang/2025_high_dose_project/observer_study_04_main/stratified study/sexes/csv_results/male'
